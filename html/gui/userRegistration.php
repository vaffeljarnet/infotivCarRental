		...
		<div id="aboutHeading">
			...
			<form NAME ="FORM" ACTION="../includes/registration.inc.php" method="POST">		
				<div id="mainText">
						...
						<input id="name" class="bigInputFields" type="text" required="required" name="firstName" pattern="(?![\s',0-9]+$)^[^±!@£$%^&*_+§¡€#¢§¶•ªº«\\/<>?:;|=.]{1,30}$" title="First name only" placeholder="First name" value="<?php echo $_SESSION['firstNamePH'];?>"><br>
						<input id="last" class="bigInputFields" type="text" required="required" name="lastName" pattern="(?![\s',0-9]+$)^[^±!@£$%^&*_+§¡€#¢§¶•ªº«\\/<>?:;|=.]{1,30}$" title="Last name only" placeholder="Last name" value="<?php echo $_SESSION['lastNamePH'];?>"><br>
